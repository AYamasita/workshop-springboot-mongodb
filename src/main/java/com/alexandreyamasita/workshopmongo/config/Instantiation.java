package com.alexandreyamasita.workshopmongo.config;
...
import com.alexandreyamasita.workshopmongo.dto.AuthorDTO;
import com.alexandreyamasita.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		userRepository.deleteAll(); //clean 
		postRepository.deleteAll();
		 ...
		 userRepository.saveAll(Arrays.asList(maria,alex,bob));	//save first users to create new id
